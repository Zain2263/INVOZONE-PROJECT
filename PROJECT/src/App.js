...
/*const CONTRACT_ADDRESS = "0xe585cabFc36865295F7Fe0F9718159368e7449aa";*/
const CONTRACT_ADDRESS = "0x6F8cCecCdC15ea5CEdFB0E7F023260D5346260Cd";
library.add(fas);

const App = () => {
  //console.log(process.env.REACT_APP_WALLET_ADD);
  const [currentAccount, setCurrentAccount] = useState("");
  const [wallet, setWallet] = useState("CONNECT YOUR METAMASK WALLET");
